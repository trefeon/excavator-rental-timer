 ...
 * 
 * 5. Network LED
 *    - Built-in LED on GPIO 2 (Active HIGH)
 * 
 * =========================================================
...
void setup() {
  ...
  digitalWrite(BUZZER_PIN, LOW);
  digitalWrite(NET_LED_PIN, LOW);  // OFF initially
  ...
  WiFi.setTxPower(WIFI_POWER_19_5dBm); // Standard TX power for ESP32
